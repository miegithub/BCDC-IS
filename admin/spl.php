          ...
          <div class="modal-dialog">
            <div class="modal-content" style="background-color:rgba(56, 174, 89);">
              <div class="modal-body text-center">
                <h5 class="text-white">Service Partner Updated Successfully!</h5>
              </div>
              ...
              <tr>
                  ...
                  <td class="text-center">
                    ...
                    ?>
                        ...
                        <button class="btn btn-success btn-sm p-0 px-1 mt-2" data-bs-toggle="modal" data-bs-target="#viewLearner<?= $row['ID']; ?>">View</button>
                    <?php
                      }
                      else{
                  ...
                  <td class="text-center p-0 pt-1">
                      ...
                      <button type="button"  class="btn btn-danger btn-sm p-0 px-1 mt-2"><i class="fa-solid fa-trash" data-bs-toggle="modal" data-bs-target="#archive<?= $row['ID']; ?>"></i></button>

                      <!-- Modal -->
                      <div class="modal fade" id="archive<?= $row['ID']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                ...
                                <button type="submit" name="archive_user" class="btn btn-danger">YES</button>
                              </div>
                            </div>
                          </div>
                        </form>
