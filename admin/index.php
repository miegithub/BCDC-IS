      ...
      <div class="container-fluid" style="background-color:rgba(217, 217, 217);height:140px;">
        <div class="row">
          ...
          <div class="col-xxl-6 col-xl-6 col-md-6 col-sm-12 col-12 text-center pt-4">
            ...
            ?>
            <p class="mb-0 pb-0 fs-2"><?= mysqli_num_rows($query_run); ?></p>
    ...
    <div class="col-xxl-3 col-xl-3 col-md-3 col-sm-12 col-12">
      <div class="container-fluid" style="background-color:rgba(217, 217, 217);height:140px;">
        <div class="row">
          ...
          <div class="col-xxl-6 col-xl-6 col-md-6 col-sm-12 col-12 text-center pt-4">
            <?php
              $query = "SELECT * FROM user WHERE approved='0' and archive='0'";
              $query_run = mysqli_query($con,$query);
            ?>
            <p class="mb-0 pb-0 fs-2"><?= mysqli_num_rows($query_run); ?></p>
            <p class="mt-0 pt-0 fs-5">Regd. Users</p>
          </div>
        </div>
        <div class="row">
          <div class="col-xxl-12 col-xl-12 col-md-12 col-sm-12 col-12 text-center p-0">
            <a href="reg-user.php" class="btn w-100 p-0 m-0" style="background-color:rgba(190, 190, 190);">View</a>
          </div>
        </div>
      </div>
    </div>
    <div class="col-xxl-3 col-xl-3 col-md-3 col-sm-12 col-12">
      <div class="container-fluid" style="background-color:rgba(217, 217, 217);height:140px;">
        <div class="row" style="padding-top: 12px;">
          ...
          <div class="col-xxl-6 col-xl-6 col-md-6 col-sm-12 col-12 text-center pt-4">
            <p class="mt-0 pt-0 fs-5">Reports<br>(Overview)</p>
          </div>
        </div>
        <div class="row" style="margin-top:6px;">
          <div class="col-xxl-12 col-xl-12 col-md-12 col-sm-12 col-12 text-center p-0">
            <a href="report-overview.php" class=" btn w-100 p-0 ms-0 me-0" style="background-color:rgba(190, 190, 190)">View</a>
          </div>
        </div>
      </div>
    </div>
