      ...
      <div class="container card pt-3 mw-100 m-0" style="width:99%;">
        ...
        <div class="row pb-3">
          <!-- LEFT -->
           <?php
              $learnerID= $_GET['id'];
              $query_learnerID = "SELECT * FROM learner WHERE learnerID='$learnerID'";
            ...
            <div class="container card pt-3 pb-3 shadow">
              ...
              <div class="row pb-2">
                <div class="col-md-12">
                  ...
                  <input type="text" name="age" class="form-control black-border" value="<?= $age; ?> years old" readonly>
                </div>
              </div>
              <div class="row pb-2">
                <div class="col-md-12">
              ...
              <div class="row pb-3">
                <div class="col-md-12">
                  ...
                  <input type="text" name="teacher_incharge" class="form-control black-border" value="<?= $teacher_in_charge; ?>" readonly>
                </div>
              </div>
            </div>
          </div>
...
<div class="col-md-9">
  ...
  <div class="row">
                      ...
                      <div class="container-fluid ps-0 ms-0">
                        ...
                        <div class="collapse navbar-collapse" id="navbarScroll">
                          <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                            ...
                            <li class="nav-item">
                              <a href="narrative-report.php?id=<?= $_GET['id']; ?>" class="me-1 nav-link active-btn text-white">Narrative Progress Report</a>
                            </li>
                          </ul>
                        </div>
                      </div>
    ...
    <!-- PHP check kung may narrative report -->
    <?php
      include('../admin/config/dbcon.php');
      $learnerID = $_GET['id'];
      $narrative_query = mysqli_query($con, "SELECT * FROM narrative_report WHERE learnerID = '$learnerID'");
    ?>

    <div class="row">
      <div class="col-md-12 hv-100">
        <div class="card">
        <?php if (mysqli_num_rows($narrative_query) > 0): ?>
          <!-- Show PDF -->
          <iframe src="pdf_narrative.php?id=<?= $learnerID; ?>" class="w-100 mw-100" frameborder="0" style="height:660px;"></iframe>
        <?php else: ?>
          <!-- Show Waiting Message justify-content-center align-items-center-->
          <div class="d-flex justify-content-center align-items-center" style="height: 660px;">
            ...
            <p class="text-black-50">The narrative progress report is currently being prepared and not yet available. <br>
