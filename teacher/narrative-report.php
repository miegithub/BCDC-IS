            ...
            <div class="container">
                      ...
                      <div class="container-fluid ps-0 ms-0">
                        ...
                        <div class="collapse navbar-collapse" id="navbarScroll">
                          <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                            ...
                            <li class="nav-item">
                              <a href="narrative-report.php?id=<?= $_GET['id']; ?>" class="me-1 nav-link active active-btn text-white">Narrative Progress Report</a>
                            </li>
                          </ul>
                        </div>
                      </div>
              ...
              <div class="row">
                <div class="col-md-12 hv-100">
                  ...
                  <div class="container">
                    <?php
                      $query = "SELECT * FROM learner WHERE learnerID='$learnerID' AND archive='0'";
                      $query_run = mysqli_query($con,$query);
                      if($query_run){
                        if(mysqli_num_rows($query_run) > 0){
                          foreach($query_run as $row){
                    ...
                    <div class="card mb-3">
                      <div class="card-body">
                        <div class="row">
                          <div><p class="text-danger">Learner's Narrative Report Details</p> <hr></div>
                          ...
                          <div class="col-md-4">
                           ...
                           <form action="nar-process.php" method="POST">
                          
                           
                            <input type="hidden" name="learnerID" class="form-control" value="<?= $learnerID; ?>" readonly>
                            
                            <?php 
                             if ($learnerID) {
                              $sql_get = "SELECT *  FROM narrative_report WHERE learnerID = '$learnerID'";
...
<!-- 
                            ...
                            <label class="m-2" for="">Progress Report Date:</label>
                            

                            <input type="date" name="pr_date" class="form-control " value="<?= htmlspecialchars($pr_date ?? '') ?>" required>
                            ...
                            <div class="m-3">
                            <label class="m-2" for="">Teacher in-charge:</label>
                          ...
                          <div class="m-3">
                            <label class="m-2" for="">Birthdate:</label>
                            <input type="text" class="form-control" value="<?= $date_of_birth; ?>" readonly>
                            </div>
                            
                          </div>
                          <div class="col-md-4">
                            <div class="m-3">
                            <label class="m-2" for="">Sex:</label>
                            <input type="text" class="form-control" value="<?= $gender; ?>" readonly>

                            </div>
                            <div class="m-3">
                            <label class="m-2" for="">Diagnosis:</label>
                    ...
                    <div class="row my-4">
                    <div><p class="text-danger">Learner’s Developmental Summary</p> <hr></div>

                      <div class="col-md-12">
                      <label class="my-3"  for=""><strong>LEARNER PROGRESS REPORT OVERVIEW</strong></label>
                        <textarea name="l_overview"  class="form-control" style="width:100%; height:150px;" required><?= isset($row['l_overview']) ? htmlspecialchars($row['l_overview']) : '' ?></textarea>
                      </div>
                    </div>
                    <div class="row mb-2">
                      <div class="col-md-12">
                      <label class="my-3"  for=""><strong>A. WORK BEHAVIOR / PLAY SKILLS</strong></label>
                      <textarea name="a_behavior" class="form-control " style="width:100%; height:300px;"><?= isset($row['a_behavior']) ? htmlspecialchars($row['a_behavior']) : '' ?></textarea>

                      </div>
                    </div>
                    <div class="row mb-2">
                      <div class="col-md-12">
                      <label class="my-3"  for=""><strong>B. GROSS MOTOR SKILLS</strong></label>
                        <textarea name="b_gross" id="" class="form-control" style="width:100%; height:150px;" required><?= isset($row['b_gross']) ? htmlspecialchars($row['b_gross']) : '' ?></textarea>
                      </div>
                    </div>
                    <div class="row mb-2">
                      <div class="col-md-12">
                      <label class="my-3"  for=""><strong>C. FINE MOTOR SKILLS</strong></label>
                        <textarea name="c_fine" id="" class="form-control" style="width:100%; height:150px;" required><?= isset($row['c_fine']) ? htmlspecialchars($row['c_fine']) : '' ?></textarea>
                      </div>
                    </div>
                    <div class="row mb-2">
                      <div class="col-md-12">
                      <label class="my-3"  for=""><strong>D. COGNITIVE AND COMMUNICATION SKILLS</strong></label>
                        <textarea name="d_cog" id="" class="form-control" style="width:100%; height:200px;" required><?= isset($row['d_cog']) ? htmlspecialchars($row['d_cog']) : '' ?></textarea>
                      </div>
                    </div>
                    <div class="row mb-2">
                      <div class="col-md-12">
                      <label class="my-3"  for=""><strong>E. ACTIVITIES OF DAILY LIVING SKILLS</strong></label>
                        <textarea name="e_act" id="" class="form-control" style="width:100%; height:150px;" required><?= isset($row['e_act']) ? htmlspecialchars($row['e_act']) : '' ?></textarea>
                      </div>
                    </div>
                    <div class="row mb-2">
                      <div class="col-md-12">
                      <label class="my-3"  for=""><strong>CLIENT’S PROGRAM</strong></label>
                        <textarea name="client_program" id="" class="form-control" style="width:100%; height:150px;" required><?= isset($row['client_program']) ? htmlspecialchars($row['client_program']) : '' ?></textarea>
                      </div>
                    </div>
                    <div class="row mb-2">
                      <div class="col-md-12">
                      <label class="my-3"  for=""><strong>RECOMMENDATION</strong></label>
                        <textarea name="recom" id="" class="form-control" style="width:100%; height:150px;" required><?= isset($row['recom']) ? htmlspecialchars($row['recom']) : '' ?></textarea>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12 mx-3 p-3 text-end">
                        <button class="btn text-white" type="submit" name="submit_narrative" style="background: rgba(31, 93, 167);">Submit</button>
                        <button class="btn text-white" style="background: rgba(122, 138, 158);">Cancel</button>
                      </div>
                      </form>
