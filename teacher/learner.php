                ...
                ?>
                      <tr>
                          ...
                          <td class="text-center p-0 pt-1" style="width:120px;">
                            <button class="btn btn-success p-1 ps-2 pe-2" data-bs-toggle="modal" data-bs-target="#viewstudent<?= $row['learnerID']; ?>"><i class="fa-solid fa-eye"></i></button>
                            <a href="ass-report.php?id=<?= $row['learnerID']; ?>" class="btn btn-primary p-1 ps-2 pe-2" ><i class="fa-solid fa-file"></i></a>
