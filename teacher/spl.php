...
if(isset($_POST['update_employee'])){
  ...
  $query_update_employee = "UPDATE `spl` SET `fname`='$fname',`lname`='$lname',`date_of_birth`='$date_of_birth',`sex`='$sex',`age`='$age',`email`='$email',`contact_no`='$contact_no',`address`='$address',`position`='$position' WHERE ID='$ID'";
        ...
        <div class="row">
          ...
          <table id="example" class="table table-striped border col-md-12 col-12" style="width:100%;font-size:12px;">
            ...
            <tbody>
              <?php
                $count=1;
                $query = "SELECT * FROM `user` WHERE archive='0' and type!='Admin' and type!='parent'";
              ...
              <tr>
                  ...
                  <td class="text-center"><?= $row['STATUS_TYPE'] ?></td>
                  <td class="text-center"><button class="btn btn-success p-2 pt-1 pb-1">View</button></td> 
                  <td class="text-center p-0 pt-1">
                    <button class="btn btn-success p-1 ps-2 pe-2" data-bs-toggle="modal" data-bs-target="#view<?= $row['ID']; ?>"><i class="fa-solid fa-eye"></i></button>
                    <button class="btn btn-primary p-1 ps-2 pe-2" data-bs-toggle="modal" data-bs-target="#editservice<?= $row['ID']; ?>"><i class="fa-solid fa-pen-to-square"></i></button>
                                        ...
                                        <div class="container-fluid p-0">
                                          ...
                                          <div class="row">
                                            <div class="col-md-12">
                                              ...
                                              <input type="text" name="accomodated_student" class="form-control black-border mb-2" required>
                                              <input type="text" name="accomodated_student1" class="form-control black-border mb-2" required>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                          ...
                                          <div class="row">
                                            <div class="col-md-4">
                                              ...
                                              <div class="col-md-4">
                                                ...
                                                <select class="form-select" name="sex" aria-label=".form-select-sm example" required>
                    ...
                    <script>
                      function showRegistration<?= $row['ID']; ?>() {
