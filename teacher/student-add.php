        ...
        if(isset($_POST['add_student'])){
          ...
          if (!in_array(strtolower($file_extension), $allowed_extension)) {
            ...
            if(move_uploaded_file($file_temp, $newprofilepath)){
              ...
              $query = "INSERT INTO `student`(fname, lname, name, `age`, `address`, `diagnosis`, `date_enrolled`, `sex`, `date_of_birth`, `registration_no`, `photo_name`, `photo_location`) VALUES ('$fname','$lname','$name','$age','$address','$diagnosis','$date_enrolled','$sex','$date_of_birth','$registration_no','$file_name','$newprofilepath')";
