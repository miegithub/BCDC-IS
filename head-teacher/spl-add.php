...
if(isset($_POST['add_spl'])){
  ...
  $query_insert_spl = "INSERT INTO dev.`spl`(`fname`, `lname`, `date_of_birth`, `sex`, `email`, `contact_no`, `address`, `position`, `photo_name`, age) VALUES ('$fname','$lname','$date_of_birth','$sex','$email','$contact_no','$address','$position','$file_name' , '$age')";
  $query_insert_spl_run = mysqli_query($con, $query_insert_spl);
  $name= $_SESSION["auth_user"]['name'];
  $position = $_SESSION["auth_user"]['position'];
  $activity = "SERVICE PARTNER ADDED SUCCESSFULLY";
        ...
        <div class="container card b mw-100 m-0" style="width:99%;">
          ...
          <div class="row mt-2">
            ...
            <div class="col-md-3">
              ...
              <input type="file" name="employee_photo" class="form-control black-border" required>
            </div>
          </div>
