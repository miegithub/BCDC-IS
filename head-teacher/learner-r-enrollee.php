  ...
  <div class="row">
    <div class="col-xxl-12 col-xl-12 col-md-12 col-sm-12 col-12">
      <div class="container card pt-3 mw-100 m-0" style="width:99%;">
        <div class="row">
          <div class="col-md-12">
            <h2>Rejected Patient Enrollee List</h2>
            <hr class="hr fw-bold">
          </div>
        </div>
        <div class="row">
          ...
          <table id="example" class="table table-striped border" style="width:100%;font-size:12px;">
            ...
            <tbody>
              <?php
                $count=1;
                $query = "SELECT * FROM `learner` WHERE archive='0' and trigger_ht='1' and trigger_dr_ass='1' and approved='2'";
