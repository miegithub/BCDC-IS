...
<div class="container mw-100 p-3 m-0 bg-white" style="width:100%;height: auto;">
  <div class="row">
    <div class="col-xxl-12 col-xl-12 col-md-12 col-sm-12 col-12">
      <h2>Developmental and Behaviorial Pediatrician Dashboard</h2>
    </div>
  </div>
  <div class="row">
    <div class="col-xxl-3 col-xl-3 col-md-3 col-sm-12 col-12">
      <div class="container-fluid" style="background-color:rgba(217, 217, 217)">
        <div class="row" style="height:130px;">
          ...
          <div class="col-xxl-6 col-xl-6 col-md-6 col-sm-12 col-12 text-center pt-4">
            ...
            <p class="mt-0 pt-0  fs-5">Patient Waiting List</p>
          </div>
        </div>
        <div class="row">
          <div class="col-xxl-12 col-xl-12 col-md-12 col-sm-12 col-12 text-center p-0">
            <a href="inquiries.php" class="btn w-100 p-0 m-0" style="background-color:rgba(190, 190, 190);">View</a>
          </div>
        </div>
      </div>
    </div>
