...
<div class="container mw-100 p-3 m-0 bg-white" style="width:100%;height:100%;">
  <div class="row">
    ...
    <?php
      include('../admin/config/dbcon.php');
      $learnerID = $_GET['id'];
      $narrative_query = mysqli_query($con, "SELECT * FROM learner_targetprogram WHERE learnerID = '$learnerID'");
    ?>
    ...
    <div class="row">
      <div class="col-md-12 hv-100">
        ...
        <?php if (mysqli_num_rows($narrative_query) > 0): ?>
          <!-- Show PDF -->
          <iframe src="pdf_ipp.php?id=<?= $learnerID; ?>" class="w-100 mw-100" frameborder="0" style="height:660px;"></iframe>
        <?php else: ?>
          ...
          <div class="d-flex justify-content-center align-items-center" style="height: 660px;">
            ...
            <p class="text-black-50">The Individualized Program Plan is currently being prepared and not yet available. <br>
