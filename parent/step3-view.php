...
<div class="container-fluid">
  <div class="row mt-2">
    ...
    <div class="col-md-6 text-end" ><button class="btn btn-primary">Next</button></div>
    <div class="col-md-12">
      <hr class=" mb-1 mt-0">
    </div>
  </div>
  <?php
    ...
    foreach($query_run as $row){
      ...
      $trigger_assessment=$row['trigger_assessment'];
      $trigger_dr_ass=$row['trigger_dr_ass'];
    }
    
    $search_learner_ass = "SELECT * FROM learner_ass WHERE learnerID='$learnerID'";
    $search_learner_ass_run = mysqli_query($con, $search_learner_ass);
    ...
    if($search_learner_run){
      if(mysqli_num_rows($search_learner_run) == 0){
                      ...
                      <div class="container-fluid">
                        ...
                        <div class="row mb-3">
                          <div class="col-md-12 text-end">
                            <button type="submit" name="submit_report" class="btn btn-primary">Next</button>
                          </div>
                        </div>
                      </div>
                    </form>
        ...
        if($trigger_dr_ass==1 && $trigger_assessment==1){
          ?>
            <div class="row">
