        ...
        if(isset($_POST['add_student'])){
          ...
          if (!in_array(strtolower($file_extension), $allowed_extension)) {
            ...
            if(move_uploaded_file($file_temp, $newprofilepath)){
              ...
              $query = "INSERT INTO `student`(fname, lname, name, `age`, `address`, `diagnosis`, `registration_date`, `sex`, `date_of_birth`, `registration_no`, `photo_name`, `photo_location`) VALUES ('$fname','$lname','$name','$age','$address','$diagnosis','$registration_date','$sex','$date_of_birth','$registration_no','$file_name','$newprofilepath')";
              $query_run = mysqli_query($con, $query);

              $select_student = "SELECT studentID FROM student WHERE name='$name' and registration_no='$registration_no'";
              $select_student_run = mysqli_query($con, $select_student);
              if($select_student_run){
                if(mysqli_num_rows($select_student_run) > 0){
                  foreach($select_student_run as $row){
                    $studentID = $row['studentID'];
                  }
                  
                  $query_insert_parent = "INSERT INTO `parent`(`studentID`, `mother_name`, `mother_occ`, `mother_contact`, `mother_email`, `father_name`, `father_occ`, `father_contact`, `father_email`, `parent_address`, guardian_name, guardian_relationship, guardian_contact, guardian_email) VALUES ('$studentID','$mother_name','$mother_occ','$mother_contact','$mother_email','$father_name','$father_occ','$father_contact','$father_email','$parent_address','$guardian_name','$guardian_relationship','$guardian_contact','$guardian_email')";
                  $query_insert_parent_run = mysqli_query($con, $query_insert_parent);
                ...
                <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content" style="background-color:rgba(56, 174, 89);">
                      <div class="modal-body text-center">
                        <h5 class="text-white">Student Added Successfully!</h5>
                      </div>
                      <div class="modal-footer">
        ...
        <div class="container card b mw-100 m-0" style="width:99%;">
          <div class="row bg-primary pt-2">
            ...
            <div class="col-md-6 text-end pt-1">
              <a href="student.php" class="text-white">Back</a>
            </div>
          </div>
          <div class="row mt-3">
            <div class="col-md-12">
              <h5 class="text-danger mb-0">Student Details</h5>
              <hr class="hr m-0">
            </div>
          </div>
          <div class="row mt-2">
          ...
          <div class="row mt-2">
            ...
            <div class="col-md-2">
              ...
              <input type="date" name="registration_date" class="form-control black-border" value="<?= $registration_date; ?>" required>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-1">
              ...
              <div class="col-md-2">
                <label class="form-label fw-light">Sex</label>
                  <select class="form-select" name="sex" aria-label="example" required>
          ...
          <div class="row mt-2">
            <div class="col-md-4">
              <label class="form-label fw-light">Student Photo</label>
